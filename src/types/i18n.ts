...
export interface TranslationKeys {
  ...
  'editor.grading.title': string;
  'editor.grading.scaleMin': string;
  'editor.grading.scaleMax': string;
  'editor.grading.score': string;
  'editor.grading.meaning': string;
  'editor.grading.hint': string;
  ...
  'editor.rules.title': string;
  'editor.rules.subtitle': string;
  'editor.rules.enabled': string;
  'editor.rules.placeholder': string;
  'editor.rules.hint': string;
  'editor.rules.error.empty': string;
  'editor.rules.error.invalidJson': string;
  'editor.rules.error.invalidSchema': string;
  ...
  'curator.honesty.title': string;
  'curator.honesty.badge.pass': string;
  'curator.honesty.badge.warning': string;
  'curator.honesty.badge.critical': string;
  'curator.honesty.summary.pass': string;
  'curator.honesty.summary.fail': string;
  'curator.honesty.severity.info': string;
  'curator.honesty.severity.warning': string;
  'curator.honesty.severity.critical': string;
  'curator.honesty.value': string;
