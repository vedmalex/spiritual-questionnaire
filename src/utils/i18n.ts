...
export const translations: TranslationSet = {
  ru: {
    ...
    'dashboard.group.absentQuestions': 'В текущей версии опросника отсутствуют вопросы: {questions}',
  ...
  en: {
    ...
    'dashboard.group.absentQuestions': 'Questions missing in current questionnaire version: {questions}',
