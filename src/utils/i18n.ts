...
export const translations: TranslationSet = {
  ru: {
    ...
    'quiz.folders.title': 'Папки опросников',
    'quiz.folders.subtitle': 'Создавайте вложенные папки и свободно перемещайте опросники.',
    'quiz.folders.studentHint': 'Выберите режим просмотра. Настройка структуры выполняется в админ-разделе.',
    'quiz.folders.createRoot': 'Новая папка',
    'quiz.folders.createNested': 'Подпапка',
    'quiz.folders.rename': 'Переименовать',
    'quiz.folders.delete': 'Удалить',
    'quiz.folders.up': 'Вверх',
    'quiz.folders.down': 'Вниз',
    'quiz.folders.moveTo': 'Переместить в',
    'quiz.folders.rootOption': 'Без папки',
    'quiz.folders.empty': 'Папка пока пустая.',
    'quiz.folders.back': 'На уровень выше',
    'quiz.folders.systemTag': 'Системная',
    'quiz.folders.userTag': 'Пользовательская',
    'quiz.folders.view.tiles': 'Плитки',
    'quiz.folders.view.tree': 'Дерево',
    'quiz.folders.tree.expand': 'Развернуть',
    'quiz.folders.tree.collapse': 'Свернуть',
    'quiz.folders.tree.count': 'Опросников: {count}',
    'quiz.folders.defaultName': 'Новая папка',
    'quiz.folders.prompt.create': 'Название папки',
    'quiz.folders.prompt.rename': 'Новое название папки',
    'quiz.folders.error.load': 'Не удалось загрузить структуру папок.',
    'quiz.folders.error.save': 'Не удалось сохранить структуру папок.',
    'quiz.folders.error.deleteNotEmpty': 'Сначала переместите содержимое папки.',
    ...
    'quiz.score.hint': 'Наведите на оценку или выберите её',
    ...
    'admin.tab.folders': 'Папки',
    'admin.tab.operations': 'Миграции и сверка',
    'admin.folders.title': 'Управление папками опросников',
    'admin.folders.subtitle': 'Продвинутый режим: системные и пользовательские папки, вложенность и переопределение размещения.',
    'admin.folders.create.title': 'Создать папку',
    'admin.folders.create.subtitle': 'Задайте расположение папки и сразу выберите элементы для переноса.',
    'admin.folders.create.name': 'Название папки',
    'admin.folders.create.parent': 'Родительская папка',
    'admin.folders.create.search': 'Поиск элементов',
    'admin.folders.create.searchPlaceholder': 'Найти папку или опросник',
    'admin.folders.create.items': 'Элементы для перемещения в новую папку',
    'admin.folders.create.noItems': 'Нет доступных элементов для выбора.',
    'admin.folders.create.confirm': 'Создать папку',
    'admin.folders.rename.title': 'Переименовать папку',
    'admin.folders.rename.name': 'Новое название',
    'admin.folders.status.created': 'Папка создана.',
    'admin.folders.status.renamed': 'Название папки обновлено.',
    'admin.folders.status.deleted': 'Папка удалена.',
    'admin.folders.status.moved': 'Элемент перемещен.',
    'admin.folders.status.reordered': 'Порядок обновлен.',
    ...
    'admin.overview.folders.description': 'Продвинутая настройка системных и пользовательских папок опросников.',
    ...
    'editor.subtitle': 'Создавайте, редактируйте и загружайте опросники. Шкала оценивания задается внутри каждого опросника.',
    ...
    'editor.grading.title': 'Шкала оценивания',
    'editor.grading.scaleMin': 'Минимальная оценка',
    'editor.grading.scaleMax': 'Максимальная оценка',
    'editor.grading.score': 'Балл {score}',
    'editor.grading.meaning': 'Описание значения',
    'editor.grading.hint': 'Эта шкала будет использоваться в прохождении, проверке и расчетах результатов данного опросника.',
    ...
    'editor.rules.title': 'Правила обработки (JSON)',
    'editor.rules.subtitle': 'Декларативные processing_rules: метрики, ranking, score override и проверки честности.',
    'editor.rules.enabled': 'Включить правила',
    'editor.rules.placeholder': '{\n  \"version\": 1,\n  \"metrics\": []\n}',
    'editor.rules.hint': 'Используется безопасный DSL без выполнения JS. При сохранении выполняется валидация схемы правил.',
    'editor.rules.error.empty': 'Включены правила обработки, но JSON-блок пуст. Заполните поле или отключите блок.',
    'editor.rules.error.invalidJson': 'Некорректный JSON в блоке правил обработки.',
    'editor.rules.error.invalidSchema': 'Блок processing_rules не прошел проверку.',
    ...
    // Score chart
    'chart.distribution.title': 'Распределение оценок по шкале опросника',
    ...
    'chart.timeline.summary': '{date} • Средний балл: {score} ({grade}). Попыток: {attempts} • Зафиксированных оценок: {answersCount}',
    ...
    'curator.subtitle': 'Проверка ответов студентов с группировкой по папкам, студентам и работам.',
    ...
    'curator.folder.title': 'Папки работ студентов',
    'curator.folder.subtitle': 'Иерархия папок с закреплением студентов и счетчиками свежих непроверенных работ.',
    'curator.folder.rootOption': 'Все папки',
    'curator.folder.studentsCount': 'Студентов: {count}',
    'curator.folder.pendingCount': 'Непроверенных: {count}',
    'curator.folder.create.title': 'Создать папку',
    'curator.folder.create.subtitle': 'Задайте расположение папки и сразу выберите студентов/папки для переноса.',
    'curator.folder.create.name': 'Название папки',
    'curator.folder.create.parent': 'Родительская папка',
    'curator.folder.create.search': 'Поиск элементов',
    'curator.folder.create.searchPlaceholder': 'Найти папку или студента',
    'curator.folder.create.items': 'Элементы для перемещения в новую папку',
    'curator.folder.create.noItems': 'Нет доступных элементов для выбора.',
    'curator.folder.create.confirm': 'Создать',
    'curator.folder.rename.title': 'Переименовать папку',
    'curator.folder.rename.name': 'Новое название',
    'curator.folder.error.load': 'Не удалось загрузить структуру кураторских папок.',
    'curator.folder.error.save': 'Не удалось сохранить структуру кураторских папок.',
    'curator.folder.error.deleteNotEmpty': 'Папка не пуста. Сначала переместите подпапки и группы студентов.',
    ...
    'curator.group.folderAssign': 'Папка студента',
    ...
    'curator.honesty.title': 'Проверка честности',
    'curator.honesty.badge.pass': 'Честность: OK',
    'curator.honesty.badge.warning': 'Честность: риск ({count})',
    'curator.honesty.badge.critical': 'Честность: критично ({count})',
    'curator.honesty.summary.pass': 'Проверка честности пройдена',
    'curator.honesty.summary.fail': 'Обнаружены риски по честности: {count}',
    'curator.honesty.severity.info': 'Инфо',
    'curator.honesty.severity.warning': 'Предупреждение',
    'curator.honesty.severity.critical': 'Критично',
    'curator.honesty.value': 'Значение: {value}',
    ...
    'curator.message.assignmentApplied': 'Назначения папок применены для {count} новых студентов.',
    ...
    'curator.import.assignment.title': 'Новые студенты после импорта',
    'curator.import.assignment.subtitle': 'Выберите существующую папку или создайте новую для каждого студента.',
    'curator.import.assignment.mode': 'Способ назначения',
    'curator.import.assignment.modeExisting': 'В существующую папку',
    'curator.import.assignment.modeNew': 'Создать новую папку',
    'curator.import.assignment.folder': 'Папка',
    'curator.import.assignment.newFolderName': 'Название новой папки',
    'curator.import.assignment.apply': 'Применить назначения',
  ...
  en: {
    ...
    'quiz.folders.title': 'Questionnaire folders',
    'quiz.folders.subtitle': 'Create nested folders and freely move questionnaires.',
    'quiz.folders.studentHint': 'Switch between compact tiles and tree view. Folder management is available in admin mode.',
    'quiz.folders.createRoot': 'New folder',
    'quiz.folders.createNested': 'Subfolder',
    'quiz.folders.rename': 'Rename',
    'quiz.folders.delete': 'Delete',
    'quiz.folders.up': 'Up',
    'quiz.folders.down': 'Down',
    'quiz.folders.moveTo': 'Move to',
    'quiz.folders.rootOption': 'No folder',
    'quiz.folders.empty': 'Folder is empty.',
    'quiz.folders.back': 'Go up one level',
    'quiz.folders.systemTag': 'System',
    'quiz.folders.userTag': 'User',
    'quiz.folders.view.tiles': 'Tiles',
    'quiz.folders.view.tree': 'Tree',
    'quiz.folders.tree.expand': 'Expand',
    'quiz.folders.tree.collapse': 'Collapse',
    'quiz.folders.tree.count': 'Questionnaires: {count}',
    'quiz.folders.defaultName': 'New folder',
    'quiz.folders.prompt.create': 'Folder name',
    'quiz.folders.prompt.rename': 'New folder name',
    'quiz.folders.error.load': 'Failed to load folder structure.',
    'quiz.folders.error.save': 'Failed to save folder structure.',
    'quiz.folders.error.deleteNotEmpty': 'Move folder contents before deleting it.',
    ...
    'quiz.score.hint': 'Hover over a score or select one',
    ...
    'admin.folders.title': 'Questionnaire folder management',
    'admin.folders.subtitle': 'Advanced mode for system/user folders, nesting, and questionnaire placement overrides.',
    'admin.folders.create.title': 'Create folder',
    'admin.folders.create.subtitle': 'Choose a parent folder and optionally move folders/questionnaires into it immediately.',
    'admin.folders.create.name': 'Folder name',
    'admin.folders.create.parent': 'Parent folder',
    'admin.folders.create.search': 'Search items',
    'admin.folders.create.searchPlaceholder': 'Find folder or questionnaire',
    'admin.folders.create.items': 'Items to move into the new folder',
    'admin.folders.create.noItems': 'No available items to choose from.',
    'admin.folders.create.confirm': 'Create folder',
    'admin.folders.rename.title': 'Rename folder',
    'admin.folders.rename.name': 'New name',
    'admin.folders.status.created': 'Folder created.',
    'admin.folders.status.renamed': 'Folder renamed.',
    'admin.folders.status.deleted': 'Folder deleted.',
    'admin.folders.status.moved': 'Item moved.',
    'admin.folders.status.reordered': 'Order updated.',
    ...
    'admin.overview.folders.description': 'Advanced configuration of system and user questionnaire folders.',
    ...
    'editor.subtitle': 'Create, edit, and upload questionnaires. The grading scale is configured per questionnaire.',
    ...
    'editor.grading.title': 'Grading scale',
    'editor.grading.scaleMin': 'Minimum score',
    'editor.grading.scaleMax': 'Maximum score',
    'editor.grading.score': 'Score {score}',
    'editor.grading.meaning': 'Meaning',
    'editor.grading.hint': 'This scale is used in quiz taking, review, and result calculations for this questionnaire.',
    ...
    'editor.rules.title': 'Processing rules (JSON)',
    'editor.rules.subtitle': 'Declarative processing_rules: metrics, ranking, score override, and honesty checks.',
    'editor.rules.enabled': 'Enable rules',
    'editor.rules.placeholder': '{\n  \"version\": 1,\n  \"metrics\": []\n}',
    'editor.rules.hint': 'A safe DSL is used (no JS execution). Rules are validated on save/export.',
    'editor.rules.error.empty': 'Rules are enabled, but the JSON block is empty. Fill it or disable rules.',
    'editor.rules.error.invalidJson': 'Invalid JSON in processing rules block.',
    'editor.rules.error.invalidSchema': 'processing_rules validation failed.',
    ...
    // Score chart
    'chart.distribution.title': 'Score distribution on questionnaire scale',
    ...
    'chart.timeline.summary': '{date} • Average score: {score} ({grade}). Attempts: {attempts} • Recorded scores: {answersCount}',
    ...
    'curator.subtitle': 'Review student answers grouped by folders, students, and assignments.',
    ...
    'curator.folder.title': 'Student Work Folders',
    'curator.folder.subtitle': 'Hierarchical folders with sticky student routing and pending-review counters.',
    'curator.folder.rootOption': 'All folders',
    'curator.folder.studentsCount': 'Students: {count}',
    'curator.folder.pendingCount': 'Pending: {count}',
    'curator.folder.create.title': 'Create folder',
    'curator.folder.create.subtitle': 'Choose a parent folder and immediately pick students/folders to move.',
    'curator.folder.create.name': 'Folder name',
    'curator.folder.create.parent': 'Parent folder',
    'curator.folder.create.search': 'Search items',
    'curator.folder.create.searchPlaceholder': 'Find folder or student',
    'curator.folder.create.items': 'Items to move into the new folder',
    'curator.folder.create.noItems': 'No available items to choose from.',
    'curator.folder.create.confirm': 'Create',
    'curator.folder.rename.title': 'Rename folder',
    'curator.folder.rename.name': 'New name',
    'curator.folder.error.load': 'Failed to load curator folder structure.',
    'curator.folder.error.save': 'Failed to save curator folder structure.',
    'curator.folder.error.deleteNotEmpty': 'Folder is not empty. Move nested folders and student groups first.',
    ...
    'curator.group.folderAssign': 'Student folder',
    ...
    'curator.honesty.title': 'Honesty Check',
    'curator.honesty.badge.pass': 'Honesty: OK',
    'curator.honesty.badge.warning': 'Honesty: risk ({count})',
    'curator.honesty.badge.critical': 'Honesty: critical ({count})',
    'curator.honesty.summary.pass': 'Honesty checks passed',
    'curator.honesty.summary.fail': 'Honesty risks detected: {count}',
    'curator.honesty.severity.info': 'Info',
    'curator.honesty.severity.warning': 'Warning',
    'curator.honesty.severity.critical': 'Critical',
    'curator.honesty.value': 'Value: {value}',
    ...
    'curator.message.assignmentApplied': 'Folder assignments applied for {count} new students.',
    ...
    'curator.import.assignment.title': 'New students after import',
    'curator.import.assignment.subtitle': 'Choose an existing folder or create a new one for each student.',
    'curator.import.assignment.mode': 'Assignment mode',
    'curator.import.assignment.modeExisting': 'Use existing folder',
    'curator.import.assignment.modeNew': 'Create new folder',
    'curator.import.assignment.folder': 'Folder',
    'curator.import.assignment.newFolderName': 'New folder name',
    'curator.import.assignment.apply': 'Apply assignments',
